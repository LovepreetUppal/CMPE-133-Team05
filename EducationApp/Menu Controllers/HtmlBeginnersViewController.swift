//
//  HtmlBeginnersViewController.swift
//
...
class HtmlBeginnersViewController: UIViewController, GADBannerViewDelegate, GADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseHandler = ref.child("ENGLISH-WebDevMain").observe(.childAdded) { (snapshot) in
        ...
        databaseHandler = ref.child("ENGLISH-WebDevCategory").observe(.childAdded) { (snapshot) in
    ...
    @IBAction func shareButton(_ sender: Any) {
        ...
        let image = UIImage(named: "wallpaper02")
...
extension HtmlBeginnersViewController {
