//
//  NasaTvMediaViewController.swift
//  Live Space
//
...
class SecondLesson: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        player = YTSwiftyPlayer(
            ...
            playerVars: [.playsInline(true), .videoID("oTIAPh-H1GI"), .loopVideo(true), .showRelatedVideo(false)])
...
extension SecondLesson: YTSwiftyPlayerDelegate {
