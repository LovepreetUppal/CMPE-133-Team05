//
//  SwiftBeginnersViewController.swift
//
...
class SwiftBeginnersViewController: UIViewController, GADBannerViewDelegate, GADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        databaseHandler = ref.child("ENGLISH-SwiftMain").observe(.childAdded) { (snapshot) in
        ...
        databaseHandler = ref.child("ENGLISH-SwiftCategory").observe(.childAdded) { (snapshot) in
...
extension SwiftBeginnersViewController {
